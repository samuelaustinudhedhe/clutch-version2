...
<x-dropdown align="right" width="40" >
    ...
    <x-slot name="content">
        <div class="w-40">
            ...
            <x-dropdown-link href="#" x-on:click="setTimeout(() => { setTheme('dark'); }, 200)">
                {{ __('Dark mode') }}
            </x-dropdown-link>

            <x-dropdown-link href="#" x-on:click="setTimeout(() => { setTheme('light'); }, 200)">
                {{ __('Light mode') }}
            </x-dropdown-link>

            <x-dropdown-link href="#" x-on:click="setTimeout(() => { setTheme('system'); }, 200)">
                {{ __('System default') }}
            </x-dropdown-link>
