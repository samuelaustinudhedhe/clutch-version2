<x-users.dashboard-layout>
    ...
    <div class="">
        ...
        <div
            ...
            <div class="mt-2 flex justify-center -mt-16">
                {{ getUserPP(true, 'rounded-full border-4 border-white h-20 w-20 object-cover') }}
            </div>

            <div class="text-center mt-2 mb-4">
                <h2 class="lg:text-xl text-lg font-semibold">{{ getUser('name') }}</h2>
                <p class="text-gray-600 lg:text-base text-sm">{{ getUser('email') }}</p>
            </div>
        </div>
        ...
        <div
            ...
            {{-- main --}}
            <a href="{{ route('user.profile.picture') }}" class="flex items-center justify-between border-b border-inherit py-4 sm:pr-8 pr-4">
            ...
            <a href="{{ route('user.profile.name') }}" class="flex items-center justify-between border-b border-inherit py-4 sm:pr-8 pr-4">
                <div class="lg:flex w-5/6 lg:w-2/3">
                    <div class="w-full lg:w-2/5 text-sm font-medium text-gray-600 dark:text-gray-400">Name</div>
                    <div class="w-full lg:w-3/5">{{ getUser('name') }}</div>
                </div>
            ...
            <a href="{{ route('user.profile.birthday') }}" class="flex items-center justify-between border-b border-inherit py-4 sm:pr-8 pr-4">
                <div class="lg:flex w-5/6 lg:w-2/3">
                    <div class="w-full lg:w-2/5 text-sm font-medium text-gray-600 dark:text-gray-400">Birthday</div>
                    <div class="w-full lg:w-3/5">{{ getUser('date_of_birth')  }}</div>
                </div>
            ...
            <a href="{{ route('user.profile.gender') }}" class="flex items-center justify-between border-inherit py-4 sm:pr-8 pr-4">
                <div class="lg:flex w-5/6 lg:w-2/3">
                    <div class="w-full lg:w-2/5 text-sm font-medium text-gray-600 dark:text-gray-400">Gender</div>
                    <div class="w-full lg:w-3/5">{{ getUser('gender') }}</div>
                </div>
        ...
        <div
            ...
            {{-- main --}}
            <a href="{{ route('user.profile.email') }}" class="flex items-center justify-between border-b border-inherit py-4 sm:pr-8 pr-4">
                <div class="lg:flex w-5/6 lg:w-2/3">
                    <div class="w-full lg:w-2/5 text-sm font-medium text-gray-600 dark:text-gray-400">Email</div>
                    <div class="w-full lg:w-3/5">{{ getUser('email') }}</div>
                </div>
            ...
            <a href="{{ route('user.profile.phone') }}" class="flex items-center justify-between border-inherit py-4 sm:pr-8 pr-4">
                <div class="lg:flex w-5/6 lg:w-2/3">
                    <div class="w-full lg:w-2/5 text-sm font-medium text-gray-600 dark:text-gray-400">Phone</div>
                    <div class="w-full lg:w-3/5">{{ getUser('phone') }}</div>
                </div>
        ...
        <div
            ...
            <a href="{{ route('user.profile.address') }}" class="flex items-center justify-between border-b border-inherit py-4 sm:pr-8 pr-4">
                <div class="lg:flex w-5/6 lg:w-2/3">
            ...
            <a href="{{ route('user.profile.address') }}" class="flex items-center justify-between border-inherit py-4 sm:pr-8 pr-4">
                <div class="lg:flex w-5/6 lg:w-2/3">
            ...
            <a href="{{ route('user.profile.password') }}"
                ...
                <div class=" w-5/6 ">
                    ...
                    <div class="w-full text-sm">
                        {{ getUser('last_password_change') ?? getUser('created_at') }}
                    </div>
                </div>
            ...
            <a href="{{ route('user.profile.2af') }}"
                ...
                <div class="lg:flex w-5/6 lg:w-2/3">
                    ...
                    <div class="w-full lg:w-3/5">
                        {{ getUser('two_factor_confirmed_at') ? 'Enabled' : 'Disabled' }}</div>
                </div>
