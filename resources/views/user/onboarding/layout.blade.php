...
<section class="bg-white dark:bg-gray-900 lg:py-0 lg:flex" wire:loading.class="opacity-50 pointer-events-none">
    ...
    <div
        ...
        <ul class="space-y-8 relative z-10">
            ...
            <li class="flex items-center space-x-4">
                <div class="relative">
                    <div
                        class="w-10 h-10 flex items-center justify-center {{ $step >= 0 ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-600' }} rounded-full">
                        <svg class="w-5 h-5 {{ $step >= 0 ? 'text-white' : 'text-gray-600 dark:text-gray-300' }}"
                    ...
                    <div
                        class="absolute w-1 h-12 {{ $step >= 0 ? 'bg-blue-600' : 'bg-gray-300 dark:bg-gray-600' }} left-1/2 transform -translate-x-1/2 top-full">
                    </div>
                </div>
                <div>
            ...
            <li class="flex items-center space-x-4">
                <div class="relative">
                    <div
                        class="w-10 h-10 flex items-center justify-center {{ $step >= 1 ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-600' }} rounded-full">
                        <svg class="w-5 h-5 {{ $step >= 1 ? 'text-white' : 'text-gray-600 dark:text-gray-300' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div
                        class="absolute w-1 h-12 {{ $step >= 1 ? 'bg-blue-600' : 'bg-gray-300 dark:bg-gray-600' }} left-1/2 transform -translate-x-1/2 top-full">
                    </div>
                </div>
                <div>
            ...
            <li class="flex items-center space-x-4">
                <div class="relative">
                    <div
                        class="w-10 h-10 flex items-center justify-center {{ $step >= 2 ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-600' }} rounded-full">
                        <svg class="w-5 h-5 {{ $step >= 2 ? 'text-white' : 'text-gray-600 dark:text-gray-300' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div
                        class="absolute w-1 h-12 {{ $step >= 2 ? 'bg-blue-600' : 'bg-gray-300 dark:bg-gray-600' }} left-1/2 transform -translate-x-1/2 top-full">
                    </div>
                </div>
                <div>
            ...
            <li class="flex items-center space-x-4">
                <div class="relative">
                    <div
                        class="w-10 h-10 flex items-center justify-center {{ $step >= 3 ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-600' }} rounded-full">
                        <svg class="w-5 h-5 {{ $step >= 3 ? 'text-white' : 'text-gray-600 dark:text-gray-300' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div
                        class="absolute w-1 h-12 {{ $step >= 3 ? 'bg-blue-600' : 'bg-gray-300 dark:bg-gray-600' }} left-1/2 transform -translate-x-1/2 top-full">
                    </div>
                </div>
                <div>
            ...
            <li class="flex items-center space-x-4">
                <div class="relative">
                    <div
                        class="w-10 h-10 flex items-center justify-center {{ $step >= 4 ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-600' }} rounded-full">
                        <svg class="w-5 h-5 {{ $step >= 4 ? 'text-white' : 'text-gray-600 dark:text-gray-300' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="grid relative items-center h-screen mx-auto md:w-[42rem] min-h-[650px] px-4 md:px-8 xl:px-0 ">
        ...
        <div class="grid mx-auto w-full my-20">
            {{-- Onboarding content --}}
            @switch($step)
                @case(0)
        ...
        <div class="items-center justify-center w-full absolute bottom-0 right-5 left-5 md:w-[38rem] ">
            ...
            <div class="flex justify-between mt-8 mb-12 w-full">
                <div
                    class="flex-1 mx-1 h-1 {{ $step >= 1 ? 'bg-blue-600 dark:bg-blue-800' : 'bg-gray-300 dark:bg-gray-500' }} rounded-full">
                </div>
                <div
                    class="flex-1 mx-1 h-1 {{ $step >= 2 ? 'bg-blue-600 dark:bg-blue-800' : 'bg-gray-300 dark:bg-gray-500' }} rounded-full">
                </div>
                <div
                    class="flex-1 mx-1 h-1 {{ $step >= 3 ? 'bg-blue-600 dark:bg-blue-800' : 'bg-gray-300 dark:bg-gray-500' }} rounded-full">
                </div>
                <div
                    class="flex-1 mx-1 h-1 {{ $step >= 4 ? 'bg-blue-600 dark:bg-blue-800' : 'bg-gray-300 dark:bg-gray-500' }} rounded-full">
                </div>
            </div>
        </div>
    </div>
