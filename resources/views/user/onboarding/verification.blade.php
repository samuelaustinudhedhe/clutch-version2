...
<div>
    ...
    <x-div><p class="mb-2 text-2xl font-extrabold tracking-tight text-gray-900 leding-tight dark:text-white">Verify your email
        address</p>
        <p class="font-light text-gray-500 dark:text-gray-400">We emailed you a six-digit code to <span
                class="font-medium text-gray-900 dark:text-white">{{ $user->email ?? 'your email' }}</span>. Enter the
            code
            below to confirm
            your
            email address.</p>
        <form action="#">
            ...
            <p class="p-4 text-sm text-gray-500 rounded-lg bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                Make
