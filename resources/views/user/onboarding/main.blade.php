{{-- Onboarding Layout --}}
<section class="relative bg-white dark:bg-gray-900 lg:py-0 lg:flex" wire:loading.class="opacity-50 pointer-events-none">
    {{-- Left Side --}}
    <div class="w-full max-lg:sticky max-lg:top-0 lg:min-h-[650px] lg:max-w-sm lg:h-screen max-lg:h-[75px] max-lg:z-10">
        <div
            class="lg:fixed w-full lg:max-w-sm lg:h-full p-4 lg:p-12 bg-gray-100 dark:bg-gray-800 text-gray-500 lg:rounded-r-2xl">
            {{-- Logo --}}
            <div class="flex items-center justify-between lg:mb-8 space-x-4">
                <a href="{{ app_url() }}" class="flex items-center text-2xl font-semibold">
            ...
            <ul class="max-lg:hidden space-y-8 relative z-10">
                {{-- Welcome --}}
            ...
            <div class="max-lg:hidden flex justify-between items-center mt-8 mb-12 absolute bottom-0">
    ...
    <div class="flex flex-col justify-between relative items-center w-full h-full">
        ...
        <x-sticky-div :isSticky="true" position="bottom-0" bgFrom="white" darkBgFrom="gray-900" gradientDirection="to-t" paddingTop="pt-16" paddingBottom="pb-4" class="items-center justify-center w-full" >
            <div class="max-w-screen-md m-auto z-10 p-4 pb-6 md:px-8 xl:px-0 bg-white dark:bg-gray-900">
                <x-steps-navigation getStarted="Begin Onboarding Now" submit="Finished Onboarding" :totalSteps="$totalSteps"
