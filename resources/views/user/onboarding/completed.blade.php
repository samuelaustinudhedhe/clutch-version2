    ...
    <div class="lg:flex">
        <div class="hidden w-full max-w-md p-12 lg:h-screen lg:block bg-blue-600">
            <div class="flex items-center mb-8 space-x-4">
                ...
                <a href="#" class="inline-flex items-center text-sm font-medium text-blue-100 hover:text-white">
            ...
            <div class="block p-8 text-white rounded-lg bg-blue-500">
                ...
                <p class="mb-4 font-light text-blue-100 sm:text-lg">30-day free trial</p>
                <!-- List -->
        ...
        <div class="flex items-center mx-auto md:w-[42rem] px-4 md:px-8 xl:px-0">
            <div class="w-full">
                ...
                <a href="#" wire:click="completeOnboarding"
                    class="block w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 sm:py-3.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Log
                    Finished Onboarding
                </a>
            </div>
        </div>
