<div class="max-w-screen-xl m-auto">
        ...
        <div class="flex items-center justify-between border-b border-inherit py-4 sm:pr-8 pr-4">
            <div class="lg:flex w-5/6 lg:w-2/3">
                ...
                <div class="w-full lg:w-3/5 {{ $this->user->hasVerifiedEmail() ? 'text-green-300' : 'text-red-300' }}"
                    title="{{ $this->user->hasVerifiedEmail() ? 'Verified' : 'Unverified Email' }}">{{ $this->user->email }}</div>
            </div>
    ...
    <div
        ...
        <div class="flex items-center justify-between border-b border-inherit py-4 sm:pr-8 pr-4">
            ...
            @if (str_contains($this->nin['file']['mime_type'], 'image'))
                <img class="mb-4 min-w-20 min-h-14 max-w-20 max-h-14 rounded border-2 border-gray-200 dark:border-white sm:mb-0 object-cover"
                    ...
                    alt="Uploaded National Identification Document">
            @else
        ...
        <div class="flex items-center justify-between border-b border-inherit py-4 sm:pr-8 pr-4">
            <div class="lg:flex w-5/6 lg:w-2/3">
                <div class="w-full lg:w-2/5 text-sm font-medium text-gray-600 dark:text-gray-400">International Passport
                </div>
            ...
            @else
            <div class="overflow-hidden  rounded border-2 border-gray-200 dark:border-white w-20 h-14 transition-transform duration-500 transform translate-x-0">

                <embed src="{{ Storage::url($this->internationalPassport['file']['path']) }}" type="application/pdf"
