        ...
        <div class="flex items-center lg:order-2">
            ...
            <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                ...
                <div class="grid grid-cols-3 gap-4 p-4">
                    <a href="#"
                        ...
                        <div class="text-sm text-gray-900 dark:text-white">Add a car</div>
                    </a>
                    <a href="#"
                        class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                        <svg aria-hidden="true"
                    ...
                    <a href="#"
                        ...
                        <div class="text-sm text-gray-900 dark:text-white">Messages</div>
                    </a>
                    <a href="#"
                        class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                        <svg aria-hidden="true"
            ...
            <div class="hidden z-50 my-4 w-56 text-base list-none bg-white  divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                ...
                <div class="py-3 px-4">
                    ...
                    <span
                        class="block text-sm text-gray-900 truncate dark:text-white">{{ $user->email }}</span>
                </div>
