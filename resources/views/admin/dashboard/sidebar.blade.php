    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2">
            ...
            <button type="button"
                ...
                <a class="flex" href="{{ route('admin.users.index') }}" >
                    {{-- Menu Icon --}}
                    <svg aria-hidden="true"
            ...
            <ul id="dropdown-users" class="hidden py-2 space-y-2">
                <li>
                    <a href="#"
                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Owners</a>
                </li>
                <li>
                    <a href="#"
                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Drivers</a>
                </li>
                <li>
                    <a href=""
                        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">All</a>
                </li>
            </ul>
            {{-- End Users Menu --}}
