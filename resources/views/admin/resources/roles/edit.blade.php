...
@include('layouts.partials.session-flash')
    ...
    <form action="#" class="mx-auto max-w-screen-xl px-4 2xl:px-0" wire:submit.prevent="update">
        ...
        <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-6">
            <div class="mt-6 min-w-0 flex-1 space-y-6 sm:mt-8 lg:mt-0 ">
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <input id="guard_admin" wire:model="guard" aria-describedby="guard_admin-text"
                            type="radio" value="admin" class="hidden peer/guard_admin" disabled/>
                        ...
                        <input id="guard_web" wire:model="guard" aria-describedby="guard_web-text" type="radio"
                            value="web" class="hidden peer/guard_web" disabled/>
                        <label for="guard_web"
                ...
                <div
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" wire:model="slug"
                            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                            placeholder="Enter role slug" disabled/>
                        @error('slug')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="w-full space-y-4 sm:space-y-6 lg:max-w-sm xl:max-w-lg">
                ...
                <div
                    class="flex space-x-6 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                    <button type="submit"
                        class="w-2/3 bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Save
                    </button>
                    <button type="button" wire:click="delete" wire:confirm="Are you sure you want to delete this role"
                        class="w-1/3 bg-red-500 hover:bg-red-700 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Delete
                    </button>
                </div>
            </div>
