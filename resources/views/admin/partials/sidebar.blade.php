...
<x-aside>
    ...
    <x-aside-menu name="Menu">
        ...
        <x-aside-menu-dropdown name="users" href="{{ route('admin.users.index') }}">
            ...
            Users
            {{-- <x-slot name="items">
                <x-aside-menu-dropdown-item name="Unverified" href="/" />
                <x-aside-menu-dropdown-item name="Hosts" href="/" />
            </x-slot> --}}
        </x-aside-menu-dropdown>
        ...
        {{-- Trips --}}
        <x-aside-menu-dropdown name="users" href="{{ route('admin.trips.index') }}">
            <svg class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        {{-- Orders --}}
        <x-aside-menu-dropdown name="orders" href="{{ route('admin.orders.index') }}">
            <svg aria-hidden="true"
                class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <x-aside-menu name="menu2" class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
        ...
        {{-- Roles --}}
        <x-aside-menu-dropdown name="roles" href="{{ route('admin.roles.index') }}">
            <svg aria-hidden="true"
                class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                viewBox="0 0 24 24">
        ...
        <x-aside-menu-dropdown name="permissions" href="{{ route('admin.permissions.index') }}">
            <svg aria-hidden="true"
                class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                viewBox="0 0 24 24">
