...
<div class=" body-font">
    <div class="lg:container px-5 py-24 mx-auto">
        <div class="flex flex-wrap -mb-10 -mx-4">
            <div class="lg:w-1/6 md:w-1/3 sm:w-1/2 w-full px-4">
                <h2 class="title-font font-medium tracking-widest text-sm mb-3">CATEGORIES</h2>
                <nav class="list-none mb-10">
                    <li>
                        <a class="text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">First Link</a>
                    </li>
                    <li>
                        <a class="text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">Second Link</a>
                    </li>
                    <li>
                        <a class="text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">Third Link</a>
                    </li>
                    <li>
                        <a class="text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">Fourth Link</a>
                    </li>
                </nav>
            </div>
            <div class="lg:w-1/6 md:w-1/3 sm:w-1/2 w-full px-4">
        ...
        <div class="container px-5 py-8 flex flex-wrap mx-auto items-center">
            <div class="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
                <div class="relative sm:w-64 w-40 sm:mr-4 mr-2">
                    <label for="footer-field" class="leading-7 text-sm text-gray-500 dark:text-gray-400">Subscribe to our Newsletter</label>
    ...
    <div class="bg-gray-100 dark:bg-gray-800">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-gray-400 text-sm text-center sm:text-left">© <?php echo date('Y'); ?> <?php echo config('app.name'); ?> —
                <a href="https://twitter.com/knyttneve" class="text-gray-500 ml-1" target="_blank"
                    rel="noopener noreferrer">@Pilot-SAU</a>
            </p>
            <span
