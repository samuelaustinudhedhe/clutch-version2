    ...
    <div class="bg-white py-8 antialiased dark:bg-gray-900">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <div
                ...
                <ul class="-mb-px flex flex-wrap gap-x-4" id="default-tab" data-tabs-toggle="#default-tab-content"
                    role="tablist">
                    <li>
                        <button id="description-tab" data-tabs-target="#description" type="button" role="tab"
                            aria-controls="description" aria-selected="true"
                            class="inline-block rounded-t-lg border-b-2 p-3 pl-0 dark:border-transparent">Description</button>
                    </li>

                    <li>
                        <button id="reviews-tab" data-tabs-target="#reviews" type="button" role="tab"
                            aria-controls="reviews" aria-selected="false"
                            class="inline-block rounded-t-lg border-b-2 p-3 hover:border-gray-300 hover:text-gray-600 dark:border-transparent dark:hover:text-gray-300">Reviews</button>
                    </li>

                    <li>
                        <button id="questions-tab" data-tabs-target="#questions" type="button" role="tab"
                            aria-controls="questions" aria-selected="false"
                            class="inline-block rounded-t-lg border-b-2 p-3 hover:border-gray-300 hover:text-gray-600 dark:border-transparent dark:hover:text-gray-300">Questions</button>
                    </li>

                    <li>
                        <button id="highlights-tab" data-tabs-target="#highlights" type="button" role="tab"
                            aria-controls="highlights" aria-selected="false"
                            class="inline-block rounded-t-lg border-b-2 p-3 hover:border-gray-300 hover:text-gray-600 dark:border-transparent dark:hover:text-gray-300">Highlights</button>
                    </li>
                </ul>
            </div>
            ...
            <div id="default-tab-content">
                <div class="w-full">
                    <div class="col-span-3">
                        <div id="description" class="grid grid-cols-1 py-4 sm:py-8 lg:grid-cols-5 lg:gap-8"
                            role="tabpanel" aria-labelledby="description-tab">
                            <div class="col-span-3 w-full space-y-6">
                                <div class="space-y-6">
                                    <p class="text-gray-500 dark:text-gray-400">The iMac "M1" 8-Core CPU/8-Core GPU/4
                                        USB-C Shaped Ports (2021) model features a 5-nm Apple M1 processor with 8 cores
                                        (4 performance cores and 4 efficiency cores), an 8-core GPU, a 16-core Neural
                                        Engine, 8 GB of onboard RAM, and a 1 TB onboard SSD.</p>

                                    <p class="text-gray-500 dark:text-gray-400">
                                        This all is housed in a wafer thin aluminum case with flat edges that includes a
                                        23.5" 4480x2520, 218 PPI, LED-backlit, "True Tone" widescreen "Retina 4.5K"
                                        display mounted on a svelte aluminum stand. This specific model is offered in
                                        the a two-tone Blue color. It also has an integrated 1080p FaceTime HD camera, a
                                        "studio-quality three-mic array" and a "high-fidelity six-speaker system" that
                                        supports Spatial Audio with Dolby Atmos.
                                    </p>

                                    <p class="text-gray-500 dark:text-gray-400">Connectivity includes two Thunderbolt /
                                        USB 4 ports and two USB 3 ports (all with a USB-C connector), a 3.5 mm headphone
                                        jack conveniently mounted on the left edge of the display, Wi-Fi 6 (802.11ax),
                                        and Bluetooth 5.0.</p>
                                </div>
                                <div class="space-y-6">
                                    <p class="text-gray-500 dark:text-gray-400">
                                        <span class="font-semibold text-gray-900 dark:text-white">Brilliant 4.5K Retina
                                            display:</span>
                                        see the big picture and all the detailsSee it all in sharp, glorious detail on
                                        the immersive 24-inch 4.5K Retina display, the P3 wide color gamut brings what
                                        you're watching to life in over a billion colors. Images shine with a brilliant
                                        500 nits of brightness.
                                    </p>

                                    <p class="text-gray-500 dark:text-gray-400">A larger sensor that captures more
                                        light. And the advanced image signal processor (ISP) of M1 greatly improves
                                        image quality. So from collaborating with coworkers to catching up with friends
                                        and family, you'll always look your best, and True Tone technology automatically
                                        adjusts the color temperature of your display to the ambient light of your
                                        environment, for a more natural viewing experience.</p>

                                    <p class="text-gray-500 dark:text-gray-400">So whether you're editing photos,
                                        working on presentations, or watching your favorite shows and movies, everything
                                        looks incredible on iMac.</p>

                                    <p class="text-gray-500 dark:text-gray-400">Your iMac comes with 90 days of
                                        complimentary technical support and a one‑year limited warranty. Purchase
                                        AppleCare+ for Mac to extend your coverage from your AppleCare+ purchase date
                                        and add unlimited repairs for accidental damage from handling, each subject to a
                                        service fee of $99 for screen damage or external enclosure damage, or $299 for
                                        other repairable accidental damage, plus applicable tax.</p>

                                    <p class="text-gray-500 dark:text-gray-400">Accessibility features help people with
                                        disabilities get the most out of their new iMac. With built-in support for
                                        vision, hearing, mobility, and learning, you can create and do amazing and
                                        creative things.</p>
                                </div>
                                ...
                                <div id="more-info" class="hidden">
                                    <div class="space-y-6">
                                        <p class="text-gray-500 dark:text-gray-400">
                                            <span class="font-semibold text-gray-900 dark:text-white">Brilliant 4.5K
                                                Retina display:</span>
                                            see the big picture and all the detailsSee it all in sharp, glorious detail
                                            on the immersive 24-inch 4.5K Retina display, the P3 wide color gamut brings
                                            what you're watching to life in over a billion colors. Images shine with a
                                            brilliant 500 nits of brightness.
                                        </p>

                                        <p class="text-gray-500 dark:text-gray-400">A larger sensor that captures more
                                            light. And the advanced image signal processor (ISP) of M1 greatly improves
                                            image quality. So from collaborating with coworkers to catching up with
                                            friends and family, you'll always look your best, and True Tone technology
                                            automatically adjusts the color temperature of your display to the ambient
                                            light of your environment, for a more natural viewing experience.</p>

                                        <p class="text-gray-500 dark:text-gray-400">So whether you're editing photos,
                                            working on presentations, or watching your favorite shows and movies,
                                            everything looks incredible on iMac.</p>

                                        <p class="text-gray-500 dark:text-gray-400">Your iMac comes with 90 days of
                                            complimentary technical support and a one‑year limited warranty. Purchase
                                            AppleCare+ for Mac to extend your coverage from your AppleCare+ purchase
                                            date and add unlimited repairs for accidental damage from handling, each
                                            subject to a service fee of $99 for screen damage or external enclosure
                                            damage, or $299 for other repairable accidental damage, plus applicable tax.
                                        </p>

                                        <p class="text-gray-500 dark:text-gray-400">Accessibility features help people
                                            with disabilities get the most out of their new iMac. With built-in support
                                            for vision, hearing, mobility, and learning, you can create and do amazing
                                            and creative things.</p>
                                    </div>
                                </div>

                                <button id="show-more" type="button" data-collapse-toggle="more-info"
                                    ...
                                    Show more
                                    <svg class="ms-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div
                                class="col-span-2 mt-4 grid w-full grid-cols-1 gap-4 sm:grid-cols-2 lg:mt-0 lg:block lg:space-y-8">
                                <div
                                    class="max-h-full rounded-lg border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Display</h2>

                                    <div
                                        class="mt-2 divide-y divide-gray-200 dark:divide-gray-700 dark:border-gray-800">
                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Screen Type
                                            </dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">light</dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Diagonal</dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">24 inches
                                            </dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Resolution
                                            </dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">4480 x
                                                2520</dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Format</dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">4k</dd>
                                        </dl>
                                    </div>
                                </div>
                                ...
                                <div
                                    class="max-h-full rounded-lg border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Processor</h2>

                                    <div
                                        class="mt-2 divide-y divide-gray-200 dark:divide-gray-700 dark:border-gray-800">
                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Processor
                                                Type</dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">Apple M3
                                            </dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Model</dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">M3</dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Physical
                                                cores</dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">8</dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Virtual Cores
                                            </dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">16</dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Technology
                                            </dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">3nm</dd>
                                        </dl>
                                    </div>
                                </div>
                                ...
                                <div
                                    class="max-h-full rounded-lg border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white">RAM memory</h2>

                                    <div
                                        class="mt-2 divide-y divide-gray-200 dark:divide-gray-700 dark:border-gray-800">
                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Capacity</dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">8GB</dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Maximum
                                                memory</dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">64GB</dd>
                                        </dl>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <dl class="flex items-center justify-between gap-4 py-2">
                                            <dt class="text-sm font-medium text-gray-900 dark:text-white">Capacity</dt>
                                            <dd class="text-sm font-normal text-gray-500 dark:text-gray-400">512GB</dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mx-auto max-w-screen-xl">
                                <div
                                    ...
                                    <div class="flex-1 space-y-3">
                                        ...
                                        <p class="text-base font-normal leading-none text-gray-500 dark:text-gray-400">
                                            Average rating</p>

                                        <div class="space-y-1">
                                            <div class="flex items-center">
                                                <svg class="h-5 w-5 text-yellow-300" aria-hidden="true"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    fill="currentColor" viewBox="0 0 24 24">
                                                    <path
                                                        d="M13.849 4.22c-.684-1.626-3.014-1.626-3.698 0L8.397 8.387l-4.552.361c-1.775.14-2.495 2.331-1.142 3.477l3.468 2.937-1.06 4.392c-.413 1.713 1.472 3.067 2.992 2.149L12 19.35l3.897 2.354c1.52.918 3.405-.436 2.992-2.15l-1.06-4.39 3.468-2.938c1.353-1.146.633-3.336-1.142-3.477l-4.552-.36-1.754-4.17Z" />
                                                </svg>
                                                <svg class="ms-0.5 h-5 w-5 text-yellow-300" aria-hidden="true"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    fill="currentColor" viewBox="0 0 24 24">
                                                    <path
                                                        d="M13.849 4.22c-.684-1.626-3.014-1.626-3.698 0L8.397 8.387l-4.552.361c-1.775.14-2.495 2.331-1.142 3.477l3.468 2.937-1.06 4.392c-.413 1.713 1.472 3.067 2.992 2.149L12 19.35l3.897 2.354c1.52.918 3.405-.436 2.992-2.15l-1.06-4.39 3.468-2.938c1.353-1.146.633-3.336-1.142-3.477l-4.552-.36-1.754-4.17Z" />
                                                ...
                                                <svg class="ms-0.5 h-5 w-5 text-gray-300 dark:text-gray-500"
                                    ...
                                    <div class="hidden min-h-full w-px shrink-0 bg-gray-200 dark:bg-gray-700 lg:block">
                                    </div>

                                    <div class="flex-1 space-y-3">
                                        <p class="text-3xl font-bold leading-none text-gray-900 dark:text-white">100M+
                                        </p>
                                        <p class="text-base font-normal leading-none text-gray-500 dark:text-gray-400">
                                            Worldwide Clients</p>
                                    ...
                                    <div class="h-px w-full shrink-0 bg-gray-200 dark:bg-gray-700 lg:hidden"></div>
                                    ...
                                    <div class="w-full max-w-md">
                                        <div class="mb-4 space-y-3">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <button type="button"
                                                    class="ms-1.5 text-sm font-medium leading-none text-gray-900 hover:underline dark:text-white">Give
                                                    a note</button>
                                            </div>
                                        </div>
                                        ...
                                        <button type="button" data-modal-target="review-modal"
                                            ...
                                            class="block rounded-lg bg-primary-700 px-5 py-2 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Write
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <label for="reviews"
                                                ...
                                                review type</label>
                                            <select id="reviews"
                                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 py-2.5 pl-2.5 pr-10 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500">
                                ...
                                <div
                                    class="mt-6 divide-y divide-gray-200 border-t border-gray-200 dark:divide-gray-700 dark:border-gray-700">
                                    <article class="py-6">
                                        <div class="mb-3 flex items-center">
                                            <img class="mr-4 h-10 w-10 rounded-lg"
                                            ...
                                            <div class="font-medium dark:text-white">
                                                ...
                                                <p class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                                    Total Reviews:
                                                    <span class="font-medium text-gray-900 dark:text-white">34</span>
                                                </p>
                                            </div>
                                        </div>

                                        <h3 class="mb-1 text-xl font-semibold text-gray-900 dark:text-white">Fast and
                                            reliable</h3>
                                        ...
                                        <div class="mb-3 flex items-center space-x-2">
                                            ...
                                            <p class="ms-2 text-sm font-normal text-gray-500 dark:text-gray-400">
                                                November 18 2023 at 15:08</p>
                                        </div>

                                        <p class="mb-3 text-base font-normal text-gray-500 dark:text-gray-400">My old
                                            IMAC was from 2013. This replacement was well needed. Very fast, and the
                                            colour matches my office set up perfectly. The display is out of this world
                                            and I’m very happy with this purchase.</p>
                                    ...
                                    <article class="py-6">
                                        ...
                                        <h3 class="mb-1 text-xl font-semibold text-gray-900 dark:text-white">Finally
                                            went back to a 'desktop'</h3>
                                        ...
                                        <div class="mb-3 flex items-center space-x-2">
                                            ...
                                            <p class="ms-2 text-sm font-normal text-gray-500 dark:text-gray-400">
                                                November 10 2023 at 17:06</p>
                                        </div>

                                        <p class="mb-3 text-base font-normal text-gray-500 dark:text-gray-400">It’s
                                            fancy, amazing keyboard, matching accessories. Super fast, batteries last
                                            more than usual, everything runs perfect in this computer. Highly recommend!
                                        </p>
                                    ...
                                    <article class="py-6">
                                        ...
                                        <h3 class="mb-1 text-xl font-semibold text-gray-900 dark:text-white">Excellent
                                            bit of kit</h3>
                                    ...
                                    <article class="py-6">
                                        ...
                                        <h3 class="mb-1 text-xl font-semibold text-gray-900 dark:text-white">The
                                            greatest computer I’ve ever had!</h3>
                                        ...
                                        <div class="mb-3 flex items-center space-x-2">
                                            ...
                                            <p class="ms-2 text-sm font-normal text-gray-500 dark:text-gray-400">
                                                October 05 2023 at 09:41</p>
                                        </div>

                                        <p class="mb-3 text-base font-normal text-gray-500 dark:text-gray-400">I have
                                            used earlier Mac computers in my university work for a number of years and
                                            found them easy to use.The iMac 2021 is no exception. It works straight out
                                            of the box giving superb definition from the HD screen.</p>
                                        <p class="mb-3 text-base font-normal text-gray-500 dark:text-gray-400">Basic
                                            tools such as a browser (Safari) and a mail client are included in the
                                            system. Microsoft Office apps can be downloaded from the App Store though
                                            they may only work in read-only mode unless you take out a subscription. The
                                    ...
                                    <article class="py-6">
                                        <div class="mb-3 flex items-center">
                                            ...
                                            <div class="font-medium dark:text-white">
                                                ...
                                                <p class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                                    Total Reviews:
                                                    <span class="font-medium text-gray-900 dark:text-white">11</span>
                                                </p>
                                            </div>
                                        </div>

                                        <h3 class="mb-1 text-xl font-semibold text-gray-900 dark:text-white">Great
                                            value for money</h3>
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <span class="text-sm text-gray-700 dark:text-gray-400">
                                        ...
                                        <span class="font-semibold text-gray-900 dark:text-white">1</span> to <span
                                            class="font-semibold text-gray-900 dark:text-white">5</span> of
                                        <span class="font-semibold text-gray-900 dark:text-white">53</span>
                                        Customer Reviews
                                    </span>
                                    <!-- Buttons -->
                                    <div class="xs:mt-0 mt-2 inline-flex">
                                        <button
                                            class="flex h-8 items-center justify-center rounded-s bg-gray-800 px-3 text-sm font-medium text-white hover:bg-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Previous</button>
                                        <button
                                            class="flex h-8 items-center justify-center rounded-e border-0 border-s border-gray-700 bg-gray-800 px-3 text-sm font-medium text-white hover:bg-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Next</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="hidden" id="questions" role="tabpanel" aria-labelledby="questions-tab">
                                    ...
                                    <div class="space-y-4 border-b border-gray-200 py-5 dark:border-gray-700">
                                        <div class="flex items-center gap-3">
                                            <p class="text-base font-semibold text-gray-900 dark:text-white">Flowbite
                                                Shop</p>
                                            <p class="text-sm font-normal text-gray-500 dark:text-gray-400">November
                                                20 2023 • 12:45</p>
                                        </div>
                                        <p class="text-base font-normal text-gray-500 dark:text-gray-400">The iMac is
                                            a line of all-in-one desktop computers designed and produced by Apple Inc.
                                            It sets itself apart by integrating the display, processing unit, and other
                                            components into a single sleek enclosure, minimizing cable clutter and
                                ...
                                <div id="accordion-product-body-12" class="hidden"
                                    ...
                                    <div class="space-y-4 border-b border-gray-200 py-5 dark:border-gray-700">
                                        ...
                                        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                                            <span class="font-semibold text-gray-900 dark:text-white">Apple
                                                Silicon:</span>
                                            Apple has transitioned its Mac lineup from Intel processors to
                                            custom-designed Apple Silicon chips. The latest iMac models might feature
                                            the latest iterations of these chips, offering improved performance and
                                            efficiency.
                                        </p>
                                        ...
                                        <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                                            <span class="font-semibold text-gray-900 dark:text-white">Vivid Retina
                                                Display:</span>
                                            iMacs typically feature high-resolution Retina displays with vibrant colors
                                            and excellent contrast. The latest models might offer improvements in
                                            display technology for even better image quality.
                                        </p>
                                        <div class="flex items-center gap-4">
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Was it
                                                helpful to you?</p>
                                    ...
                                    <div class="space-y-4 border-b border-gray-200 py-5 dark:border-gray-700">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Was it
                                                helpful to you?</p>
                                            <div class="flex items-center">
                                                <input id="default-radio-5" type="radio" value=""
                                            ...
                                            <div class="flex items-center">
                                                <input id="default-radio-6" type="radio" value=""
                                                    name="default-radio-3"
                                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                    ...
                                    <div class="space-y-4 border-b border-gray-200 py-5 dark:border-gray-700">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Was it
                                                helpful to you?</p>
                                            <div class="flex items-center">
                                                <input id="default-radio-7" type="radio" value=""
                                            ...
                                            <div class="flex items-center">
                                                <input id="default-radio-8" type="radio" value=""
                                                    name="default-radio-4"
                                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                    ...
                                    <div class="space-y-4 border-b border-gray-200 py-5 dark:border-gray-700">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Was it
                                                helpful to you?</p>
                                            <div class="flex items-center">
                                                <input id="default-radio-9" type="radio" value=""
                                            ...
                                            <div class="flex items-center">
                                                <input id="default-radio-10" type="radio" value=""
                                                    name="default-radio-5"
                                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                    ...
                                    <div class="space-y-4 border-b border-gray-200 py-5 dark:border-gray-700">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Was it
                                                helpful to you?</p>
                                            <div class="flex items-center">
                                                <input id="default-radio-11" type="radio" value=""
                                            ...
                                            <div class="flex items-center">
                                                <input id="default-radio-12" type="radio" value=""
                                                    name="default-radio-6"
                                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                    ...
                                    <div class="space-y-4 border-b border-gray-200 py-5 dark:border-gray-700">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Was it
                                                helpful to you?</p>
                                            <div class="flex items-center">
                                                <input id="default-radio-13" type="radio" value=""
                                            ...
                                            <div class="flex items-center">
                                                <input id="default-radio-14" type="radio" value=""
                                                    name="default-radio-7"
                                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                    ...
                                    <div class="space-y-4 border-b border-gray-200 py-5 dark:border-gray-700">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Was it
                                                helpful to you?</p>
                                            <div class="flex items-center">
                                                <input id="default-radio-15" type="radio" value=""
                                                    name="default-radio-8"
                                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                            ...
                                            <div class="flex items-center">
                                                <input id="default-radio-16" type="radio" value=""
                                                    name="default-radio-8"
                                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                                <label for="default-radio-16"
                                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">No:
                                                    3 </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="space-y-4 border-b border-gray-200 py-5 dark:border-gray-700">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Was it
                                                helpful to you?</p>
                                            <div class="flex items-center">
                                                <input id="default-radio-17" type="radio" value=""
                                                    name="default-radio-9"
                                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                                <label for="default-radio-17"
                                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                    Yes: 16 </label>
                                            </div>
                                            <div class="flex items-center">
                                                <input id="default-radio-18" type="radio" value=""
                                                    name="default-radio-9"
                                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                                <label for="default-radio-18"
                                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">No:
                                                    3 </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="space-y-4 border-b border-gray-200 py-5 dark:border-gray-700">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Was it
                                                helpful to you?</p>
                                            <div class="flex items-center">
                                                <input id="default-radio-19" type="radio" value=""
                                                    name="default-radio-10"
                                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                                <label for="default-radio-19"
                                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                    Yes: 16 </label>
                                            </div>
                                            <div class="flex items-center">
                                                <input id="default-radio-20" type="radio" value=""
                                                    name="default-radio-10"
                                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                                <label for="default-radio-20"
                                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">No:
                                                    3 </label>
                                            </div>
                                        </div>
                            ...
                            <div class="mt-6 sm:mt-8">
                                <p class="text-lg font-normal text-gray-500 dark:text-gray-400">
                                    ...
                                    <a href="#" title=""
                                        class="font-medium text-primary-700 underline hover:no-underline dark:text-primary-500">Ask
                                        a question</a>
                                </p>
                            </div>
                        </div>
                        <div class="hidden" id="highlights" role="tabpanel" aria-labelledby="highlights-tab">
                            <div class="mt-6 grid gap-4 sm:mt-8 sm:grid-cols-2 lg:grid-cols-3">
                                <div
                                    ...
                                    <span class="text-gray-500 dark:text-gray-400">Processor Model</span>
                                    <h3 class="mt-1 text-lg font-bold text-gray-900 dark:text-white">Apple M3</h3>
                                    <ul role="list"
                                        class="my-4 space-y-1 text-left text-gray-500 dark:text-gray-400">
                                        <li class="flex items-center space-x-2">
                                            <!-- Icon -->
                                            <svg class="h-5 w-5 shrink-0 text-green-600 dark:text-green-500"
                                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <li class="flex items-center space-x-2">
                                            ...
                                            <span>Multitasks well</span>
                                        </li>
                                    </ul>
                                    <a href="#"
                                        class="font-medium text-primary-700 hover:underline dark:text-primary-500">Why
                                        is the processor important?</a>
                                </div>
                                <div
                                    class="rounded-lg border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                                    <span class="text-gray-500 dark:text-gray-400">Graphics</span>
                                    <h3 class="mt-1 text-lg font-bold text-gray-900 dark:text-white">Apple M3 8-core
                                    </h3>
                                    <ul role="list"
                                        class="my-4 space-y-1 text-left text-gray-500 dark:text-gray-400">
                                        <li class="flex items-center space-x-2">
                                        ...
                                        <li class="flex items-center space-x-2">
                                            ...
                                            <span>Ideal for casual gamers</span>
                                        </li>
                                    </ul>
                                    <a href="#"
                                        class="font-medium text-primary-700 hover:underline dark:text-primary-500">Choose
                                        the best graphic card</a>
                                </div>
                                <div
                                    class="rounded-lg border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                                    <span class="text-gray-500 dark:text-gray-400">System Memory (RAM)</span>
                                    <h3 class="mt-2 text-lg font-bold text-gray-900 dark:text-white">8 gigabytes</h3>
                                    <ul role="list"
                                        class="my-4 space-y-1 text-left text-gray-500 dark:text-gray-400">
                                        <li class="flex items-center space-x-2">
                                            <!-- Icon -->
                                            ...
                                            <span>Excellent multitasking</span>
                                        </li>
                                        <li class="flex items-center space-x-2">
                                            <!-- Icon -->
                                            <svg class="h-5 w-5 shrink-0 text-green-600 dark:text-green-500"
                                            ...
                                            <span>Advanced photo/video editing</span>
                                        </li>
                                        <li class="flex items-center space-x-2">
                                            <!-- Icon -->
                                            <svg class="h-5 w-5 shrink-0 text-green-600 dark:text-green-500"
                                            ...
                                            <span>Mid-range gaming</span>
                                        </li>
                                    </ul>
                                    <a href="#"
                                        class="font-medium text-primary-700 hover:underline dark:text-primary-500">How
                                        much RAM do I need?</a>
                                </div>
                                <div
                                    class="rounded-lg border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                                    <span class="text-gray-500 dark:text-gray-400">Display Type</span>
                                    <h3 class="mt-2 text-lg font-bold text-gray-900 dark:text-white">OLED</h3>
                                    <ul role="list"
                                        class="my-4 space-y-1 text-left text-gray-500 dark:text-gray-400">
                                        <li class="flex items-center space-x-2">
                                            <!-- Icon -->
                                        ...
                                        <li class="flex items-center space-x-2">
                                            ...
                                            <span>Best viewing angle is center</span>
                                        </li>
                                    </ul>
                                    <a href="#"
                                        class="font-medium text-primary-700 hover:underline dark:text-primary-500">What’s
                                        the difference between display types?</a>
                                </div>
                                <div
                                    class="rounded-lg border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                                    <span class="text-gray-500 dark:text-gray-400">Total Storage Capacity</span>
                                    <h3 class="mt-2 text-lg font-bold text-gray-900 dark:text-white">256 gigabytes
                                    </h3>
                                    <ul role="list"
                                        class="my-4 space-y-1 text-left text-gray-500 dark:text-gray-400">
                                        <li class="flex items-center space-x-2">
                                        ...
                                        <li class="flex items-center space-x-2">
                                            ...
                                            <span>Ideal for casual gaming</span>
                                        </li>
                                        <li class="flex items-center space-x-2">
                                            <!-- Icon -->
                                            <svg class="h-5 w-5 shrink-0 text-green-600 dark:text-green-500"
                                            ...
                                            <span>Some photo/video editing</span>
                                        </li>
                                    </ul>
                                    <a href="#"
                                        class="font-medium text-primary-700 hover:underline dark:text-primary-500">How
                                        much storage do I need?</a>
                                </div>
                                <div
                                    class="rounded-lg border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                                    <span class="text-gray-500 dark:text-gray-400">Screen Resolution</span>
                                    <h3 class="mt-2 text-lg font-bold text-gray-900 dark:text-white">4480 x 2520</h3>
                                    <ul role="list"
                                        class="my-4 space-y-1 text-left text-gray-500 dark:text-gray-400">
                                        <li class="flex items-center space-x-2">
                                            <!-- Icon -->
                                            ...
                                            <span>Lifelike images and graphics</span>
                                        </li>
                                        <li class="flex items-center space-x-2">
                                            <!-- Icon -->
                                            <svg class="h-5 w-5 shrink-0 text-green-600 dark:text-green-500"
                                            ...
                                            <span>Up to 4x the pixels of Full HD</span>
                                        </li>
                                        <li class="flex items-center space-x-2">
                                            <!-- Icon -->
                                            <svg class="h-5 w-5 shrink-0 text-green-600 dark:text-green-500"
                                            ...
                                            <span>Brings 4K content to life</span>
                                        </li>
                                    </ul>
                                    <a href="#"
                                        class="font-medium text-primary-700 hover:underline dark:text-primary-500">Compare
                                        screen resolutions</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form class="p-4 md:p-5">
                    <div class="mb-4 grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            <label for="issue-radio"
                                class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">What kind of
                                issue you're having?</label>
                            <div class="mb-2 flex items-center">
                                <input id="issue-radio" type="radio" value="" name="issue-radio"
                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                <label for="issue-radio"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Report listing
                                    abuse</label>
                            </div>
                            <div class="flex items-center">
                                <input checked id="issue-radio-2" type="radio" value=""
                                    name="issue-radio"
                                    class="h-4 w-4 border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                <label for="issue-radio-2"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Report a
                                    violation</label>
                            </div>
                        </div>
                        <div class="col-span-2">
                            <label for="reason"
                                class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Report
                                reason</label>
                            <input type="text" name="reason" id="reason"
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                                required="" />
                        </div>
                        <div class="col-span-2">
                            <label for="description"
                                class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Describe your
                                issue</label>
                        ...
                        <div class="col-span-2">
                            <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"
                                for="file_input">Add an attachment</label>
                            <input
                                class="block w-full cursor-pointer rounded-lg border border-gray-300 bg-gray-50 text-sm text-gray-900 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:placeholder:text-gray-400"
                        ...
                        <div class="col-span-2">
                            <div class="flex items-center">
                                ...
                                <label for="link-checkbox"
                                    class="ms-2 text-sm font-medium text-gray-500 dark:text-gray-400">I have read and
            ...
            <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
                ...
                <div
                    ...
                    <div>
                        ...
                        <a href="#"
                            class="font-medium text-primary-700 hover:underline dark:text-primary-500">Apple iMac 24"
                            All-In-One Computer, Apple M1, 8GB RAM, 256GB SSD</a>
                    </div>
                    <button type="button"
