    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div
            ...
            <div class="items-center justify-between pb-4 md:flex">
                <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white md:mb-0">Electronics - Top
                    Products <span class="ms-2 text-lg font-medium text-gray-500 dark:text-gray-400">298
                        products</span></h2>
            ...
            <div class="items-center justify-between space-y-4 py-4 lg:flex lg:space-y-0">
                ...
                <div class="grid grid-cols-2 items-center gap-4 md:flex ">
                    ...
                    <div id="dropdownBrands"
                        ...
                        <ul class="p-2 text-start text-sm font-medium text-gray-900 dark:text-white">
                            <li
                                ...
                                <input id="brand-checkbox-1" type="checkbox" value=""
                                ...
                                <label for="brand-checkbox-1"
                                    class="inline-flex w-full items-center gap-2 text-gray-900 dark:text-gray-300">Apple
                                    <span class="ms-auto text-gray-500 dark:text-gray-400">1,276</span></label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="brand-checkbox-2" type="checkbox" value=""
                                    class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="brand-checkbox-2"
                                    class="inline-flex w-full items-center gap-2 text-gray-900 dark:text-gray-300">Microsoft
                                    <span class="ms-auto text-gray-500 dark:text-gray-400">2,522</span></label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="brand-checkbox-3" type="checkbox" value=""
                                    class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="brand-checkbox-3"
                                    class="inline-flex w-full items-center gap-2 text-gray-900 dark:text-gray-300">Samsung
                                    <span class="ms-auto text-gray-500 dark:text-gray-400">3,766</span></label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="brand-checkbox-4" type="checkbox" value=""
                                    class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-800 dark:focus:ring-blue-600"
                                    checked />
                                <label for="brand-checkbox-4"
                                    class="inline-flex w-full items-center gap-2 text-gray-900 dark:text-gray-300">Sony
                                    <span class="ms-auto text-gray-500 dark:text-gray-400">1,011</span></label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="brand-checkbox-5" type="checkbox" value=""
                                    class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="brand-checkbox-5"
                                    class="inline-flex w-full items-center gap-2 text-gray-900 dark:text-gray-300">Bosch
                                    <span class="ms-auto text-gray-500 dark:text-gray-400">967</span></label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="brand-checkbox-6" type="checkbox" value=""
                                    class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="brand-checkbox-6"
                                    class="inline-flex w-full items-center gap-2 text-gray-900 dark:text-gray-300">ASUS
                                    <span class="ms-auto text-gray-500 dark:text-gray-400">1,022</span></label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="brand-checkbox-7" type="checkbox" value=""
                                    class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="brand-checkbox-7"
                                    class="inline-flex w-full items-center gap-2 text-gray-900 dark:text-gray-300">Dell
                                    <span class="ms-auto text-gray-500 dark:text-gray-400">467</span></label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="brand-checkbox-8" type="checkbox" value=""
                                    class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="brand-checkbox-8"
                                    class="inline-flex w-full items-center gap-2 text-gray-900 dark:text-gray-300">Huawei
                                    <span class="ms-auto text-gray-500 dark:text-gray-400">604</span></label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="brand-checkbox-9" type="checkbox" value=""
                                    class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="brand-checkbox-9"
                                    class="inline-flex w-full items-center gap-2 text-gray-900 dark:text-gray-300">Lenovo
                                    <span class="ms-auto text-gray-500 dark:text-gray-400">249</span></label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <label for="brand-checkbox-10"
                                    class="inline-flex w-full items-center gap-2 text-gray-900 dark:text-gray-300">Philips
                                    <span class="ms-auto text-gray-500 dark:text-gray-400">969</span></label>
                            </li>
                        </ul>
                        <div class="p-2">
                            <button type="button"
                    ...
                    <button id="priceDropdownButton" data-dropdown-toggle="dropdownPrice" type="button"
                        class="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 sm:w-auto">
                        <svg class="-ms-0.5 me-2 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-width="2"
                        ...
                        <ul class="p-2 text-start text-sm font-medium text-gray-900 dark:text-white">
                            <li
                                ...
                                <label for="price-range-1"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Under $10
                                </label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <label for="price-range-2"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> $10 to $20
                                </label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <label for="price-range-3"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> $20 to $30
                                </label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <label for="price-range-4"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> $30 to $40
                                </label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <label for="price-range-5"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> $40 to $50
                                </label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <label for="price-range-6"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> $50 to $60
                                </label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <label for="price-range-7"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> $60 to $70
                                </label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <label for="price-range-8"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> $70 to $80
                                </label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <label for="price-range-9"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> $80 to $90
                                </label>
                            </li>
                            <li
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <label for="price-range-10"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Over $100
                                </label>
                            </li>
                        </ul>
                        <div class="p-2">
                ...
                <div class="shrink-0 items-center gap-4 sm:flex">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        <div class="flex items-center">
                            <input id="1-year" name="warranty" type="checkbox" value=""
                                class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                            <label for="1-year" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                Flowbite
                            </label>
                        </div>

                        <div class="flex items-center">
                            <input id="2-years" type="checkbox" name="warranty" value=""
                                class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                            <label for="2-years" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                BestBuy </label>
                        </div>

                        <div class="flex items-center">
                            <input id="3-years" type="checkbox" name="warranty" value=""
                                class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                            <label for="3-years" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                Amazon </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="pt-4">
                <div class="mb-4 items-center md:flex md:justify-between">
                    <div class="mb-4 items-center gap-4 sm:flex md:mb-0">
                        <p class="mb-2 shrink-0 text-base font-medium text-gray-900 dark:text-white sm:mb-0">Order
                            by:</p>

                        <div class="flex flex-wrap items-center gap-3">
                            <div class="flex items-center">
                                <input id="newest-products" name="order" type="radio" value=""
                                    class="h-4 w-4 rounded-full border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="newest-products"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Newest
                                </label>
                            </div>

                            <div class="flex items-center">
                                <input id="incr-price" type="radio" name="order" value=""
                                    class="h-4 w-4 rounded-full border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="incr-price"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Increasing
                                    price </label>
                            </div>

                            <div class="flex items-center">
                                <input id="decr-price" type="radio" name="order" value=""
                                    class="h-4 w-4 rounded-full border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="decr-price"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Decreasing
                                    price </label>
                            </div>

                            <div class="flex items-center">
                                <input id="most-popular" type="radio" name="order" value=""
                                    class="h-4 w-4 rounded-full border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="most-popular"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Most popular
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div id="controls-carousel" class="relative w-full" data-carousel="static">
                        ...
                        <div class="flex items-center justify-center gap-4 -m-4">
                            <button type="button"
                                class="group flex h-full cursor-pointer items-center justify-center rounded-lg p-1.5 hover:bg-gray-50 focus:outline-none dark:hover:bg-gray-800"
                                data-carousel-prev>
                                <span
                    ...
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <div class="flex items-center justify-end gap-2">
                            <p class="text-2xl font-semibold leading-tight text-gray-900 dark:text-white">₦
                                {{ json_decode($vehicle->price, true)['amount'] }}<span class="text-lg">/
                                    day</span></p>
            ...
            <ul class="flex h-8 items-center -space-x-px text-sm">
                ...
                <li>
                    <a href="#" aria-current="page"
                        class="z-10 flex h-8 items-center justify-center border border-blue-300 bg-blue-50 px-3 leading-tight text-blue-600 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:hover:bg-gray-700 dark:text-white dark:hover:text-white">3</a>
                </li>
                <li>
                    <a href="#"
                        class="z-10 flex h-8 items-center justify-center border border-gray-300 bg-white px-3 leading-tight text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">...</a>
                </li>
                <li>
                    <a href="#"
