<div class="max-w-screen-3xl py-8 antialiased dark:bg-gray-900 md:py-12 mx-auto px-8">
    <!-- Heading & Filters -->
    ...
    {{-- Content --}}
    <section class="w-full flex lg:max-h-[calc(100vh-100px)] flex-col-reverse lg:flex-row">
