              ...
              <div class="items-center mb-3 space-y-4 sm:flex sm:space-y-0">
                <div class="relative w-full mr-3">
                  <label for="member_email"
                    class="hidden mb-2 text-sm font-medium text-gray-900 sr-only dark:text-gray-300">Email address</label>
          ...
          <div class="grid max-w-5xl gap-6 mx-auto mt-8 lg:mt-12 sm:grid-cols-2 lg:gap-10 lg:grid-cols-4">
            ...
            <a href="{{ app_url('vehicles') }}"
              ...
              <div
                ...
                <svg class="w-5 h-5 text-teal-600 lg:w-6 lg:h-6 dark:text-teal-400" fill="currentColor" viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <a href="{{ app_url('blog') }}"
              ...
              <div
                ...
                <svg class="w-5 h-5 text-green-600 dark:text-green-400 lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd"
